...
public:
  ...
  uint64_t getPacketsReceived() const { return packetsReceivedCount.load(); }
  uint64_t getPacketsSent() const { return packetsSentCount.load(); }
  uint64_t getFramesReceived() const { return framesReceivedCount.load(); }
  uint64_t getFramesSent() const { return framesSentCount.load(); }
  uint64_t getFramesDropped() const { return framesDroppedCount.load(); }
  uint64_t getBufferOverruns() const { return bufferOverrunsCount.load(); }
