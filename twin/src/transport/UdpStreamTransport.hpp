...
//
// High-bandwidth I/Q streaming using UDP packets.
...
struct UdpPacketHeader {
    ...
    uint8_t flags;          // Reserved (0 = I/Q data, future: 1 = TX audio)
    ...
    static constexpr uint8_t FLAG_TX_AUDIO = 1;  // Future: NexRig TX audio
